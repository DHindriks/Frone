...
public class Camerascript : MonoBehaviour {
    ...
    void FixedUpdate () {
        ...
        transform.GetChild(0).rotation = Quaternion.Slerp(this.transform.GetChild(0).rotation, Quaternion.Slerp(TargetRotation, transform.rotation, LookLerpamount), LookLerpspeed * Time.deltaTime);
    }
}
